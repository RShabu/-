            ...
            <div class="cont-main">
                <table class="table table-hover" style="border-bottom: 1px solid #e7e7e7;">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="">
                           <a href="${pageContext.request.contextPath}/article/grp_article_list?boardCode=SECRETARY">
                           <i class="fas fa-clipboard-list font16"></i> ${boardTitle} 게시판</a>
                        </td>
                        <td class="right p-lr10 ">
                            <a href="${pageContext.request.contextPath}/article/grp_article_list?boardCode=SECRETARY" style="color:#000;">바로가기
                                <i class="fas fa-arrow-right"></i></a>
                        </td>
                    </tr>
                </table>
