		...
		<div class="content-text">
			...
			<div class="page-right bg-white">
				<div class="page-main-wrap">
					...
					<div class="content-text flex flex-justify" style="width:100%;">
						<div style="width:50%;">
							<div class="title">
						...
						<div style="width:48%;">
							...
							<div class="calendar-insert">
								<form>
									<table class="m-t20">
										<tr>
											<td class="td-20 noto under bg-gray weight700 center"><i class="fas fa-calendar-alt font16"></i> 시작일자 </td>
											<td class="p-lr3"><input type="text"
												autocomplete="off" id="startDate" name="startDate" class="input-100" /></td>
										</tr>
										<tr>
											<td class="td-20 noto under bg-gray weight700 center"><i class="fas fa-calendar-alt font16"></i> 종료일자 </td>
											<td class="p-lr3"><input type="text"
												autocomplete="off" id="endDate" name="endDate"class="input-100" /></td>
										</tr>
										<tr>
											<td class="td-20 noto under bg-gray weight700 center"><i class="far fa-calendar-check"></i> 일정내용</td>
